          ...
          <div className="flex items-center gap-3">
            {user ? (
              ...
              <button
                ...
                className="flex items-center gap-3 px-6 py-2.5 bg-orange-500/20 border-2 border-orange-400/40 hover:border-orange-400/60 text-orange-100 font-semibold rounded-lg transition-all shadow-sm hover:shadow"
              >
