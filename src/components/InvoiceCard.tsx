import { Calendar, Building2, DollarSign, FileText, Tag, Trash2 } from 'lucide-react';
...
export function InvoiceCard({ expense, onDelete, showDelete = false }: InvoiceCardProps) {
